...
const GoogleLoginButton = ({
  ...
  return (
    <button 
      ...
      {...onLongPress()}
    >
      <svg className="select-none" xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
      ...
      <p className="text-sm font-medium select-none safari-drag-none">{isAnother ? "다른 " : ""}디미고 구글 계정으로 로그인</p>
    </button>
  );
};
